...
#[derive(Debug)]
pub struct ElixirFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ElixirFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ElixirFlow processing");
    
    let mut processor = ElixirFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ElixirFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ElixirFlowProcessor::new(false);
